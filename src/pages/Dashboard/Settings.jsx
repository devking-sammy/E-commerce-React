  ...
  return (
    <div className="max-w-2xl mx-auto mt-12 bg-white shadow-2xl rounded-2xl p-8">
      ...
      <div className="mt-10 border-t pt-8">
        <h4 className="text-lg font-semibold mb-4 text-gray-700">Admin Quick Actions</h4>
        <div className="flex flex-wrap gap-4 justify-center">
          <button className="bg-blue-100 text-blue-700 px-4 py-2 rounded-lg font-medium hover:bg-blue-200 transition">
            Manage Users
          </button>
          <button className="bg-green-100 text-green-700 px-4 py-2 rounded-lg font-medium hover:bg-green-200 transition">
            View Orders
          </button>
          <button className="bg-yellow-100 text-yellow-700 px-4 py-2 rounded-lg font-medium hover:bg-yellow-200 transition">
            Payment Settings
          </button>
          <button className="bg-red-100 text-red-700 px-4 py-2 rounded-lg font-medium hover:bg-red-200 transition">
            Logout
          </button>
        </div>
      </div>
